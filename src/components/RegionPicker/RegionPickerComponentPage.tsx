      ...
      <div className="max-w-4xl w-full">
        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-[#A0A0A8] text-lg max-w-3xl mx-auto leading-relaxed">
            We will store your data in the region you choose to provide you with better performance and compliance with local regulations. You can change this later in your account settings.
          </p>
        </div>
