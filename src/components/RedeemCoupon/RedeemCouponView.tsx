      ...
      <header className="bg-white border-b border-gray-200 px-4 py-4 sm:px-6 lg:px-8">
        <div className="flex items-center space-x-4">
          <button
            ...
            aria-label={t('redeemCoupon.backToDashboard')}
          >
            <ArrowLeft className="w-5 h-5 text-[#A0A0A8]" />
          </button>
          <div>
            <h1 className="text-xl font-bold text-[#2B2C34] font-['Inter']">{t('redeemCoupon.title')}</h1>
            <p className="text-sm text-[#A0A0A8]">{t('redeemCoupon.description')}</p>
          </div>
        </div>
      </header>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 mb-6 shadow-sm">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                <span className="text-[#A0A0A8]">{t('redeemCoupon.customer')} ID:</span>
                <span className="text-[#2B2C34] font-medium">{couponData.customer_id}</span>
              </div>
              
              <div className="flex items-center justify-between">
                <span className="text-[#A0A0A8]">{t('redeemCoupon.validPeriod')}:</span>
